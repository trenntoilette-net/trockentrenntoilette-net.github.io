...
export default {
  name: "TrelinoEvoS",
  head: {
    title: "Trelino Evo S - Mobile Trenntoilette im Test",
    meta: [
      {
        hid: "description",
        name: "description",
  ...
  asyncData: () => {
    return {
      product: products.find((item) => item.name === "Trelino EVO S"),
    };
  },
  jsonld() {
    return {
      ...
      "@graph": [
        {
          ...
          offers: {
            "@type": "Offer",
            url: "https://www.trockentrenntoilette.net/trelino-evo-s/",
            priceCurrency: "EUR",
            price: "299.00",
        ...
        },
        {
          ...
          itemListElement: [
            ...
            },
            {
              ...
              position: 2,
              item: {
                "@id": "https://www.trockentrenntoilette.net/trelino-evo-s/",
                name: this.product.name,
              },
            },
          ],
