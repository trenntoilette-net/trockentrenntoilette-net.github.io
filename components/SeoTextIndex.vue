    ...
    <div class="row g-5">
      <div class="col-lg-8 offset-lg-2 fadeInUp" style="min-height: 400px">
        ...
        <p class="mb-4">
          ...
          Sanitärinstallationen nicht möglich, zunehmender Beliebtheit:
        </p>
        <div class="mb-4">
          <ul>
            <li>im Wohnmobil</li>
        ...
        <p class="mb-4">
          Wo Menschen zusammenkommen oder länger verweilen, ist es gut, eine
          Toilette zu besitzen. Doch nicht immer lässt die Infrastruktur in
          abgelegenen Regionen, auf Naturgrundstücken, in Wasserschutzgebieten
          oder unterwegs Sanitärinstallationen zu.
        </p>
        <p class="mb-4">
          Trockentrenntoiletten sind hier die optimale Lösung - sie kommen ganz
        ...
        <p class="mb-4">
          ...
          und eine Toilettenschüssel. Über bestimmte Systeme landen entweder
          alle Hinterlassenschaften in einem Behälter, der dann geleert werden
        ...
        <p class="mb-4">
          ...
          unangenehmen Gerüchen führen kann. Da Menschen wesentlich mehr Urin
          ausscheiden und dieser nicht ganz so schnell unangenehm riecht, kann
          der Behälter in anderen Intervallen entsorgt werden. Während Urin in
          die Natur gegossen werden kann, werden feste Ausscheidungen in der
          Regel anders entsorgt.
        </p>
        <p class="mb-4">
          In vielen Trenntoiletten wird Festes zusätzlich mit etwas
          Naturmaterial abgedeckt, wodurch Gerüche deutlich reduziert werden.
        </p>
        ...
        <div class="mb-4 h2 pt-5">
          Worauf muss beim Kauf einer Trockentrenntoilette geachtet werden?
        </div>

        <p class="mb-4">
          Wichtigste Kaufkriterien sind die Größe, Funktionalität, die Art der
