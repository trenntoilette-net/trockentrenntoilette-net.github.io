            ...
            <div class="row g-5">
                ...
                <div class="col-lg-3 col-md-6">
                    ...
                    <div class="row g-2 pt-2">
                        <div class="col-4">
                            <img class="img-fluid bg-light p-1" src="assets/images/trockentrenntoiletten/trockentrenntoilette-trobolo-terabloem.webp" alt="">
                        </div>
                        <div class="col-4">
                            <img class="img-fluid bg-light p-1" src="assets/images/trockentrenntoiletten/trockentrenntoilette-trobolo-kersaboem.webp" alt="">
                        </div>
                        <div class="col-4">
                            <img class="img-fluid bg-light p-1" src="assets/images/trockentrenntoiletten/trockentrenntoilette-trobolo-indiebloem.webp" alt="">
                        </div>
                        <div class="col-4">
                            <img class="img-fluid bg-light p-1" src="assets/images/trockentrenntoiletten/trockentrenntoilette-meinetrenntoilette-trelino-l.webp" alt="">
                        </div>
                        <div class="col-4">
                            <img class="img-fluid bg-light p-1" src="assets/images/trockentrenntoiletten/trockentrenntoilette-kildwick-miniloo.webp" alt="">
                        </div>
                        <div class="col-4">
                            <img class="img-fluid bg-light p-1" src="assets/images/trockentrenntoiletten/trockentrenntoilette-trobolo-kitaboem.webp" alt="">
                        </div>
                    </div>
                </div>
                <div class="col-lg-3 col-md-6">
